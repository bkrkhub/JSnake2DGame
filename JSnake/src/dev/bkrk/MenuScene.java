...
public class MenuScene extends Scene{
    ...
    public MenuScene(KL keyListener, ML mouseListener) {
        ...
        try{
            BufferedImage menuImg = ImageIO.read(new File("assets/menuSprite.png"));
            title = menuImg.getSubimage(0, 242, 960, 240);
            play = menuImg.getSubimage(0, 121, 261, 121);
            playPressed = menuImg.getSubimage(264, 121, 261, 121);
            exit = menuImg.getSubimage(0, 0, 233, 93);
            exitPressed = menuImg.getSubimage(264, 0, 233, 93);
        }catch (Exception e) {
            e.printStackTrace();
        }
    ...
    public void draw(Graphics g) {
        g.setColor(new Color(151, 245, 244));
